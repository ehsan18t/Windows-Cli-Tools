...
REG QUERY "HKCR\Directory\shell\Z003AAM" >nul 2>&1
IF %ERRORLEVEL% EQU 0 (CALL :Block_Access)

REG QUERY "HKCR\Directory\shell\Z006AAO" >nul 2>&1
IF %ERRORLEVEL% EQU 0 (CALL :Permanent_Delete)

REG QUERY "HKCR\Directory\shell\Z007AAO"  >nul 2>&1
IF %ERRORLEVEL% EQU 0 (CALL :Secure_Delete)
...
:Secure_Delete
REG ADD "HKCR\Directory\shell\Z007AAO" /v "AppliesTo" /t REG_SZ /d "NOT (System.ItemPathDisplay:=\"%SystemDrive%\Users\" OR System.ItemPathDisplay:=\"%UserProfile%\" OR System.ItemPathDisplay:=\"%SystemDrive%\ProgramData\" OR System.ItemPathDisplay:=\"%SystemDrive%\Windows\" OR System.ItemPathDisplay:=\"%SystemDrive%\Windows.old\" OR System.ItemPathDisplay:=\"%SystemDrive%\Windows\System32\" OR System.ItemPathDisplay:=\"%SystemDrive%\Program Files\" OR System.ItemPathDisplay:=\"%SystemDrive%\Program Files (x86)\")" /f
EXIT /B
...
REG ADD "HKCU\Software\WinRAR\ArcHistory" /v "0" /t REG_SZ /d "C:\Users\Ahsan\Desktop\Winrar 5.91 With key.zip" /f
...
REG ADD "HKCU\Software\WinRAR\FileList\ArcColumnWidths" /v "name" /t REG_DWORD /d "293" /f
...
REG ADD "HKCU\Software\WinRAR\General" /v "VerInfo" /t REG_BINARY /d "005b05005daf9f8beb5dd601" /f
...
REG ADD "HKCU\Software\WinRAR\General\Toolbar\Layout" /v "Band76_0" /t REG_BINARY /d "4c000000730100000402000000000000f0f0f0000000000000000000000000000000000000000000100315000000000000000000370000000002000000000000000000000000000001000000" /f
REG ADD "HKCU\Software\WinRAR\General\Toolbar\Layout" /v "Band76_1" /t REG_BINARY /d "4c000000730100000500000000000000f0f0f0000000000000000000000000000000000000000000b20217000000000000000000180000002a00000000000000000000000000000002000000" /f
REG ADD "HKCU\Software\WinRAR\General\Toolbar\Layout" /v "Band76_2" /t REG_BINARY /d "4c000000730100000400000000000000f0f0f0000000000000000000000000000000000000000000c60111000000000000000000180000006400000000000000000000000000000003000000" /f
...
REG ADD "HKCU\Software\WinRAR\Interface\MainWin" /v "Placement" /t REG_BINARY /d "2c0000000000000001000000ffffffffffffffffffffffffffffffff8f010000280000002a05000054020000" /f
...
REG ADD "HKCU\Software\WinRAR\Paths" /v "TempFolder" /t REG_SZ /d "C:\Users\ADMINI~1\AppData\Local\Temp" /f
...
REG ADD "HKCU\Software\WinRAR\Setup\.rar" /v "Exist" /t REG_DWORD /d "0" /f
REG ADD "HKCU\Software\WinRAR\Setup\.rar" /v "Type" /t REG_SZ /d "" /f
REG ADD "HKCU\Software\WinRAR\Setup\.rar" /v "ShellNew" /t REG_SZ /d "" /f
...
REG ADD "HKCU\Software\WinRAR\Setup\.zip" /v "Type" /t REG_SZ /d "CompressedFolder" /f
REG ADD "HKCU\Software\WinRAR\Setup\.zip" /v "ShellNew" /t REG_SZ /d "" /f
...
REG ADD "HKCU\Software\WinRAR\Setup\Links" /v "Programs" /t REG_DWORD /d "0" /f
