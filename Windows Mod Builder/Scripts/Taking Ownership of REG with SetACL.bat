...
XCOPY /e /i /y "%Environment%\REG\21H1\LIB FILES\Windows" "%Environment%\Toolkit\Mount\Install\1\Windows"
ECHO  -^> Copying Post Install Files
XCOPY /e /i /y "%Environment%\REG\21H1\Post Install [Apps]\Windows" "%Environment%\Toolkit\Mount\Install\1\Windows"
ECHO  -^> Copying Post Scripts
XCOPY /e /i /y "%Environment%\REG\21H1\Post Script\Windows" "%Environment%\Toolkit\Mount\Install\1\Windows"
XCOPY /e /i /y "%Environment%\REG\21H1\Post Script\Users" "%Environment%\Toolkit\Mount\Install\1\Users"
